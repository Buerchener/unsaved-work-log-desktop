...
const Desktop=(()=>{
 ...
 function openDocument(id){
  ...
  if(t&&!state.completed.includes(id)&&(!canWork()||tasks[state.completed.length]?.id!==id)){toast(state.stage==='tuesday'?'周二的工作尚未开放。':!canWork()?'今天已结束工作，这项事项尚未完成。':'这份文件还在等待前一项事项。');return;}
